...
// constants.ts yerine doğrudan veriyi buraya kopyalayalım
...
function generateSitemap() {
  ...
  console.log(`   - Toplam İl: ${Object.keys(CITIES_WITH_DISTRICTS).length}`);
  console.log(`   - Toplam İlçe: ${totalDistricts}`);
  console.log(`   - Hizmet türü: ${services.length}`);
  console.log(`   - SEO sayfaları: ${addedCount.toLocaleString('tr-TR')}`);
  console.log(`   - Marka sayfaları: ${POPULAR_BRANDS.length}`);
