...
-- Not: CURRENT_DATE IMMUTABLE olmadığı için partial index'te kullanılamaz
-- Sadece status bazlı partial index kullanıyoruz, tarih filtresi query'de yapılacak
