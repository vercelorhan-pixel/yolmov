          ...
          <AnimatePresence>
            {isLocationOpen && (
              <motion.div 
                ...
                className="absolute top-[110%] left-0 w-full md:min-w-[350px] bg-white rounded-2xl shadow-2xl border border-gray-100 max-h-[350px] overflow-y-auto z-[100] py-2"
              >
          ...
          <AnimatePresence>
            {isServiceOpen && (
              <motion.div 
                ...
                exit={{ opacity: 0, scale: 0.98, y: 10 }}
                transition={{ duration: 0.2 }}
                className="absolute top-[110%] left-0 md:-left-12 w-full md:w-[120%] bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden z-[100]"
              >
