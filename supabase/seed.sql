...
('r1111111-1111-1111-1111-111111111111'::uuid, 
 ...
 'p1111111-1111-1111-1111-111111111111'::uuid, 'Hızlı Çekici Hizmetleri',
...
('r2222222-2222-2222-2222-222222222222'::uuid,
 ...
 'p3333333-3333-3333-3333-333333333333'::uuid, 'Express Çekici',
...
('r3333333-3333-3333-3333-333333333333'::uuid,
 ...
 'p4444444-4444-4444-4444-444444444444'::uuid, '7/24 Yol Yardım',
...
('o1111111-1111-1111-1111-111111111111'::uuid, 'r1111111-1111-1111-1111-111111111111'::uuid, 
 'p1111111-1111-1111-1111-111111111111'::uuid, 'Hızlı Çekici Hizmetleri', 
 1500.00, 20, 'Hemen yola çıkıyoruz', 'accepted'),

-- Devam eden iş için kabul edilen teklif
('o2222222-2222-2222-2222-222222222222'::uuid, 'r2222222-2222-2222-2222-222222222222'::uuid,
 'p3333333-3333-3333-3333-333333333333'::uuid, 'Express Çekici',
 1800.00, 15, '15 dakikada oradayız', 'accepted'),

-- Eşleşmiş iş için kabul edilen teklif
('o3333333-3333-3333-3333-333333333333'::uuid, 'r3333333-3333-3333-3333-333333333333'::uuid,
 'p4444444-4444-4444-4444-444444444444'::uuid, '7/24 Yol Yardım',
 500.00, 25, 'Akü takviyesi yapabiliriz', 'accepted'),

-- Açık talep için gönderilen teklifler
('o4444444-4444-4444-4444-444444444444'::uuid, 'r4444444-4444-4444-4444-444444444444'::uuid,
 'p2222222-2222-2222-2222-222222222222'::uuid, 'Güvenilir Yol Yardım',
 450.00, 30, 'Lastik değişimi hızlıca yapılır', 'sent'),

('o5555555-5555-5555-5555-555555555555'::uuid, 'r4444444-4444-4444-4444-444444444444'::uuid,
 'p1111111-1111-1111-1111-111111111111'::uuid, 'Hızlı Çekici Hizmetleri',
...
('rv111111-1111-1111-1111-111111111111'::uuid,
 'j1111111-1111-1111-1111-111111111111'::uuid,
 'p1111111-1111-1111-1111-111111111111'::uuid, 'Hızlı Çekici Hizmetleri',
...
('rv222222-2222-2222-2222-222222222222'::uuid,
 'j2222222-2222-2222-2222-222222222222'::uuid,
 'p2222222-2222-2222-2222-222222222222'::uuid, 'Güvenilir Yol Yardım',
...
('rv333333-3333-3333-3333-333333333333'::uuid,
 'j3333333-3333-3333-3333-333333333333'::uuid,
 'p3333333-3333-3333-3333-333333333333'::uuid, 'Express Çekici',
...
('d3333333-3333-3333-3333-333333333333'::uuid,
 'p5555555-5555-5555-5555-555555555555'::uuid, 'Yeni Partner A.Ş.',
...
('ct111111-1111-1111-1111-111111111111'::uuid,
 'p1111111-1111-1111-1111-111111111111'::uuid, 'Hızlı Çekici Hizmetleri',
 'purchase', 100, 0, 100, '100 kredi satın alındı',
 NOW() - INTERVAL '10 days'),

('ct222222-2222-2222-2222-222222222222'::uuid,
 'p1111111-1111-1111-1111-111111111111'::uuid, 'Hızlı Çekici Hizmetleri',
 'usage', -50, 100, 50, 'Talep görüntüleme için kullanıldı',
 NOW() - INTERVAL '2 days'),

('ct333333-3333-3333-3333-333333333333'::uuid,
 'p3333333-3333-3333-3333-333333333333'::uuid, 'Express Çekici',
...
('l1111111-1111-1111-1111-111111111111'::uuid,
 ...
 'approve', 'document', 'd1111111-1111-1111-1111-111111111111'::uuid,
 'Partner belgesi onaylandı: Sürücü belgesi',
 NOW() - INTERVAL '30 days'),

('l2222222-2222-2222-2222-222222222222'::uuid,
 'a1111111-1111-1111-1111-111111111111'::uuid, 'Super Admin',
 'approve', 'partner', 'p1111111-1111-1111-1111-111111111111'::uuid,
 'Partner hesabı aktif edildi: Hızlı Çekici Hizmetleri',
 NOW() - INTERVAL '35 days'),

('l3333333-3333-3333-3333-333333333333'::uuid,
 'a2222222-2222-2222-2222-222222222222'::uuid, 'Destek Ekibi',
 'update', 'ticket', 't1111111-1111-1111-1111-111111111111'::uuid,
